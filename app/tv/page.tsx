...
<section className="relative z-0 h-[45vh] sm:h-[50vh] md:h-[60vh] w-full">
  ...
  {/* <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/55" /> */}
      ...
      <div className="max-w-[1400px] mx-auto md:px-4 h-full flex items-end">
        <div className="pb-10 sm:pb-0 md:pb-5 -ml-2 md:ml-8 xl:ml-20  w-full lg:w-1/2">
          {/* Title image or text */}
          <div className="mb-4">
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-6xl font-extrabold tracking-tight ml-10">STRANGER THINGS SEASON 5</h1>
          </div>
